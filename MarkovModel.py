...
######CHANGES COME IN HERE BASED ON LABELS IN PARAMETER CLASSES....######
        # update survival time
        if next_state in [P.HealthStats.STROKE_DEATH, P.HealthStats.NORMAL_DEATH]:
        ...
        ####We can update the current state & costs here.
    ...
    def get_if_alive(self):
        result = True
        if self._currentState in [P.HealthStats.STROKE_DEATH, P.HealthStats.NORMAL_DEATH]:
            result = False
        return result
...
class PatientCostUtilityMonitor:
    ...
    def __init__(self, parameters):
        ...
        self._total_discounted_utility = 0
        # current health state
        self._currentState = parameters.get_initial_health_state()
    ...
    def get_total_discounted_utility(self):
        """ :returns total discounted utility"""
        return  self._total_discounted_utility
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        self._count_strokes = []
        self._costs = []                #discount costs
        self._utilities =[]             # discount utils
