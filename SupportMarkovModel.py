...
def print_comparative_outcomes(simOutputs_none, simOutputs_anticoag):
    ...
    increase_survival_time = Stat.DifferenceStatIndp(
        ...
        y_ref=simOutputs_anticoag.get_survival_times())
    ...
    increase_stroke_time = Stat.DifferenceStatIndp(
        ...
        y_ref=simOutputs_anticoag.get_if_developed_stroke())
...
def report_CEA_CBA(simOutputs_none, simOutputs_anticoag):
    ...
    # do CEA
    CEA = Econ.CEA(
        strategies=[simOutputs_MONO, simOutputs_COMBO],
        if_paired=False
    )
    # show the CE plane
    CEA.show_CE_plane(
